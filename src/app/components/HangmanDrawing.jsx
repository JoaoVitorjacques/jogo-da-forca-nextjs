const HEAD = (
  <div key="head" style={{
    width: "50px", height: "50px", borderRadius: "100%", border: "10px solid black",
...
const RIGHT_ARM = (
  <div key="right-arm" style={{
    ...
    position: "absolute", top: "150px", right: "-100px", rotate: "-30deg",
...
const LEFT_ARM = (
  <div key="left-arm" style={{
    width: "100px", height: "10px", background: "black",
    position: "absolute", top: "150px", right: "10px", rotate: "30deg",
...
const RIGHT_LEG = (
  <div key="right-leg" style={{
    width: "100px", height: "10px", background: "black",
    position: "absolute", top: "210px", right: "-90px", rotate: "60deg",
    transformOrigin: "left bottom"
  }} />
)
...
const LEFT_LEG = (
  <div key="left-leg" style={{
    width: "100px", height: "10px", background: "black",
    position: "absolute", top: "210px", right: 0, rotate: "-60deg",
    transformOrigin: "right bottom"
  }} />
)
